...
JUPYTER_SERVER_OAI_PATH = os.getenv("JUPYTER_SERVER_OAI_PATH") or "/home/sandbox/.openai_internal/"
sys.path.append(JUPYTER_SERVER_OAI_PATH)

from applied_ace_client.ace_types.user_machine_types import MethodCall, ObjectReference

_BASE_URL = "http://localhost"
_USER_MACHINE_PORT = 8080
FEATURE_SET = os.getenv("ACE_TOOLS_FEATURE_SET") or os.getenv("FEATURE_SET")
